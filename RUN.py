def coffee_Lsharp():
    ...
    #learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule="SepSeq", separation_rule="SepSeq", max_learning_rounds=200, print_level=3, crash_output="F", retry_output="W", goto_outputs=["*"])
    learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule="SepSeq", separation_rule="SepSeq", max_learning_rounds=200, print_level=3)
...
def rsa_Lsharp():
    ...
    # learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule="SepSeq", separation_rule="SepSeq", max_learning_rounds=200, print_level=3, crash_output="Alert Fatal (Unexpected message)", goto_outputs=["ChangeCipherSpec & Finished"])
    learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule="SepSeq", separation_rule="SepSeq", max_learning_rounds=200, print_level=3)
...
def haraka_Lsharp():
    ...
    learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule="ADS", separation_rule="ADS", max_learning_rounds=200, print_level=3, crash_output=" 221", retry_output=" 500")
