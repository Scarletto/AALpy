def coffee_Lsharp():
    ...
    learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule=None, separation_rule="SepSeq", max_learning_rounds=200, print_level=3, crash_output="F", retry_output="W", goto_outputs=["*"])
    # learned_mealy = run_Lsharp(input_alphabet, sul_mealy, eq_oracle, automaton_type='mealy', extension_rule=None, separation_rule="SepSeq", max_learning_rounds=200, print_level=3)
